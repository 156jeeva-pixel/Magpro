      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <Card className="p-8 md:p-12 bg-white rounded-3xl  border-gray-100 shadow-lg hover:border-[#2D5BFF] hover:shadow-blue-300 hover:-translate-y-2 transition-all duration-300">
            ...
            <Card className="p-8 md:p-12 bg-white rounded-3xl  shadow-lg  border-gray-100 hover:border-[#2D5BFF] hover:shadow-blue-300 hover:-translate-y-2 transition-all duration-300">
              <div className="bg-[#2D5BFF]/10 w-16 h-16 rounded-2xl flex items-center justify-center text-[#2D5BFF] mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto items-start">
            {team.map((member, index) => (
              <Card
                key={index}
                className="bg-white rounded-3xl  shadow-lg border-gray-100 hover:border-[#2D5BFF] hover:shadow-2xl hover:shadow-blue-600 hover:-translate-y-2 transition-all duration-300 overflow-hidden group cursor-pointer flex flex-col h-full"
              >
